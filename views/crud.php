...
<br>
  ...
  <?php foreach($result as $row){ ?>
    <tr>
      ...
      <td><a href="edit?id=<?php echo $row['cod_producto']?>" class="btn btn-primary">Editar</a></td>
      <td><a href="delite?id=<?php echo $row['cod_producto']?>" class="btn btn-danger" >Eliminar</a></td>
    </tr>
        <?php }?>
  </tbody>
</table>
